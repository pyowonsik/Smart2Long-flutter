...
class SpellingTryTest extends StatefulWidget {
  const SpellingTryTest({Key? key}) : super(key: key);

  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => SpellingTryTest());
  }

  @override
  State<SpellingTryTest> createState() => _SpellingTryTest();
}

class _SpellingTryTest extends State<SpellingTryTest> {
  ...
  Future getValidationTest() async {
    ...
    setState(() {
      finalClass = prefs.getString('sclass').toString();
